...
class BaseUbl(models.AbstractModel):
    ...
    def _ubl_add_party_tax_scheme(
        ...
        if commercial_partner.vat:
            ...
            company_id.text = commercial_partner.country_id.code + commercial_partner.vat
    ...
    def _ubl_add_party(
        ...
        endpoint = etree.SubElement(party, ns['cbc'] + 'EndpointID')
        endpoint.set('schemeID', '9923')
        endpoint.text = partner.vat if partner else company.vat
